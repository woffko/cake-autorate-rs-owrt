...
ip() {
	test "$*" = '-4 route get 1.1.1.1 from 192.0.2.102 mark 0x200'
	printf '%s\n' '1.1.1.1 from 192.0.2.102 via 192.0.2.100 dev eth0 table 2 mark 0x200'
}
test "$(route_device_for_mark 192.0.2.102 0x200)" = eth0
